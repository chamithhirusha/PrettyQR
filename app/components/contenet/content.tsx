...
import { DownloadIcon, QRIcon, ReloadIcon } from "../icons/Icons";
...
const Content = () => {
  ...
  return (
    <div style={{ width: "100%", height: "100vh", position: "relative" }}>
      ...
      {/* Foreground content */}
      <section
        className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center gap-10 p-8 relative z-10 text-white"
      >
        {/* Input & Options */}
